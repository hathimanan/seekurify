...
<p className="text-gray-700 mb-4">
  At Securify, your privacy and security are our top priorities. This Privacy Policy explains how we collect, use, and protect your information when you use our platform, including our password manager, link checker, file & malware scanner, and system dashboard.
</p>
...
<p className="text-gray-700">
  If you have any questions about this Privacy Policy or need assistance with your account, please contact us at <a href="mailto:support@securify.com" className="text-blue-600 underline">support@securify.com</a>.
</p>
